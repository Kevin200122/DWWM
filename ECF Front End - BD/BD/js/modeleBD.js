jQuery(document).ready(function ($) {
	...
	//Presentation d'une BD
	console.log("Presentation de la BD");
	var couverture = couverture.get(laCouverture);
	var titre = titre.get(leTitre);
	var prix = prix.get(lePrix);
	console.log(laCouverture + " " + leTitre+ " "+ lePrix);
	...
	for(var [idSerie, serie] of series.entries()) {
	    ...
	    for (var [idAlbum, album] of albums.entries()) {
	        if (album.idSerie == idSerie) {
	            console.log(serie.nom+", Album N°"+album.numero+" "+album.titre+", Auteur:"+auteur.get(album.idAuteur).nom);
	        }
	    }
	...
	for(var [idAuteur, auteur] of auteurs.entries()) {
	    ...
	    for (var [idAlbum, album] of albums.entries()) {
	        if (albums.idAuteur == idAuteur) {
	            console.log(auteur.nom+", Album N°"+album.numero+" "+album.titre+", Série:"+serie.get(album.idSerie).nom);
	        }
	    }
	 ...
	 */
	function afficheAlbums($albumMini, $album, nomFic, nomFic) {
